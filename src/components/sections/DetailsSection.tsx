...
export const DetailsSection: React.FC = () => {
  const details: Detail[] = [
    ...
    },
    {
      ...
      footnote: <>* Vi har reserverat rum på Hotell Havsbaden Grisslehamn. Ange koden "<span className="font-bold">810695</span>" vid bokning via telefon. I bokningen ingår spa från 12:00 och möjlighet för tidigare incheckning för 100:-/timme</>
    },
    {
      id: 'dresscode',
      icon: Shirt,
      ...
      <div className="space-y-2">
        ...
        {detail.footnote && (
          <>
            ...
            <p className="text-[8px] md:text-[10px] text-muted-foreground italic">
              {detail.footnote}
            </p>
          </>
        )}
