      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-4">
            <h2 className="font-lemon-milk text-[14px] md:text-[18px] text-primary">
              Vår Historia
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="transform hover:scale-105 transition-transform duration-300 shadow-lg border-2 border-primary/10">
              <CardContent className="p-8 text-center space-y-4">
                ...
                <h3 className="font-lemon-milk text-[12px] text-secondary">
                  Första Intrycket
                </h3>
          ...
          <div className="bg-transparent backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-primary/20">
            <blockquote className="font-lemon-milk text-[14px] md:text-[18px] text-primary text-center leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center space-y-2">
              <div className="text-[14px] md:text-[18px] font-lemon-milk text-primary">X</div>
              <div className="text-sm text-muted-foreground">År tillsammans</div>
            </div>
            <div className="text-center space-y-2">
              <div className="text-[14px] md:text-[18px] font-lemon-milk text-primary">∞</div>
              <div className="text-sm text-muted-foreground">Minnen skapade</div>
            </div>
            <div className="text-center space-y-2">
              <div className="text-[14px] md:text-[18px] font-lemon-milk text-primary">1</div>
