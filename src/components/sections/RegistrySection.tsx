        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="bg-transparent rounded-2xl p-8 text-center space-y-6 border-2 border-primary/20">
            ...
            <div className="space-y-4">
              <h3 className="font-lemon-milk font-normal text-[14px] md:text-[16px] text-primary">
                Kära vänner och familj
              </h3>
              <p className="text-[10px] md:text-[12px] text-muted-foreground leading-relaxed max-w-2xl mx-auto">
            ...
            {registryOptions.map((option, index) => (
              ...
              >
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="font-lemon-milk font-normal text-[14px] md:text-[16px] text-secondary">
                    {option.title}
                  </CardTitle>
                </CardHeader>
                <CardContent className="text-center space-y-4">
                  <p className="text-muted-foreground text-[10px] md:text-[12px]">
                    {option.description}
                  </p>
