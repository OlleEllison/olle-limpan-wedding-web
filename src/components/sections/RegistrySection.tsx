        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="bg-transparent rounded-2xl p-8 text-center space-y-6 border-2 border-primary/20">
            ...
            <div className="space-y-4">
              <h3 className="font-lemon-milk text-[12px] text-primary">
            ...
            {registryOptions.map((option, index) => (
              ...
              >
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="font-lemon-milk text-[12px] text-secondary">
                    {option.title}
                  </CardTitle>
                </CardHeader>
          ...
          <div className="text-center space-y-4">
            <div className="inline-block bg-wedding-cream border-2 border-dashed border-primary/30 rounded-2xl p-6 transform -rotate-1 shadow-lg">
              <p className="font-lemon-milk text-[14px] md:text-[18px] text-primary">
